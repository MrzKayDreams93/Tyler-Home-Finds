...
export default function Component() {
  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden font-sans bg-gray-100">
      ...
      <div className="relative w-full max-w-4xl space-y-8 text-center z-10 p-4 sm:p-6 my-4 sm:my-8">
        <div className="space-y-4">
          <h1 className="text-3xl sm:text-5xl font-bold text-teal-600 drop-shadow-lg whitespace-normal sm:whitespace-nowrap flex flex-col sm:flex-row items-center justify-center">
            <span className="font-serif italic tracking-tighter" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.3)' }}>TYLERS</span>
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-xl p-4 sm:p-8 space-y-4 sm:space-y-6 shadow-lg">
          <p className="text-lg sm:text-xl text-gray-700 font-medium drop-shadow-md" style={{ fontFamily: "'Segoe UI', 'Roboto', sans-serif" }}>
            For nearly half a century, TYLERS has been the heart of family shopping in Texas and a go-to destination!
          </p>
          ...
          {!isSubmitted ? (
            ...
            <div className="space-y-2">
              <p className="text-xl sm:text-2xl font-semibold text-teal-600 drop-shadow-md" style={{ fontFamily: "'Comic Sans MS', cursive, sans-serif" }}>You are on the list!</p>
              <p className="text-lg sm:text-xl text-gray-700 drop-shadow-md" style={{ fontFamily: "'Segoe UI', 'Roboto', sans-serif" }}>We are excited to introduce you to a trusted and exciting way to decorate homes.</p>
            </div>
          )}

          <p className="text-lg sm:text-xl text-gray-700 font-medium drop-shadow-md" style={{ fontFamily: "'Segoe UI', 'Roboto', sans-serif" }}>
            Join the waitlist for this EXCITING NEW addition that is gonna make TYLERS HOME FINDS that HOME GO-TO DESTINATION!
          </p>
        </div>
        ...
        <div className="mt-6 sm:mt-8">
          <p className="text-base sm:text-lg text-gray-700 drop-shadow-sm" style={{ fontFamily: "'Segoe UI', 'Roboto', sans-serif" }}>
            Brought to you by TYLERS - 
            <a href="https://tylerstx.com" className="text-orange-400 hover:underline ml-1 font-semibold">
              it is a Texas tradition built on a foundation of quality and trust.
            </a>
          </p>
        </div>
      </div>
